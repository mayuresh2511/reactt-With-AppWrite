...
function Post() {
  ...
  useEffect(() => {
    ...
    .catch((error) => console.log("Error while geting post : ", error));
  }, []);
  ...
  return (
    <main className="mt-10">
      ...
      <div className="mb-4 md:mb-0 w-full mx-auto relative">
        ...
        <img src="https://images.unsplash.com/photo-1587614387466-0a72ca909e16?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2100&q=80" className="w-full object-cover lg:rounded" style={{height: 28 + 'em'}}/>
      </div>
        ...
        <div className="w-full lg:w-1/4 m-auto mt-12 max-w-screen-sm">
          <div className="p-4 border-t border-b md:border md:rounded">
            <div className="flex py-2">
              ...
              <div>
                <p className="font-semibold text-gray-700 text-sm"> {post.userId} </p>
